...
def detect_and_predict_mask_identiy(frame, faceNet, maskNet):
	...
	for i in range(0, detections.shape[2]):
		...
		if confidence > args["confidence"]:
			...
			# for face detection find indentity here and add in the locs
...
while True:
	...
	# face mask or not
	(locs, preds) = detect_and_predict_mask_identiy(frame, faceNet, maskNet)
	input_embeddings,facerec = create_input_image_embeddings()
